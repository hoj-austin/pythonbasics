...
while len(newHangar) > 0:
    ...
    if len(newHangar) == 2:
        continue
    print(newHangar)
print('While loop with continue complete! You lost your R22 and EC130 in the same hit... dayuuuuum')

# conditionals
x = int(input("How many planes do you have? "))
if x > 3: print('You must work for ANZ')
elif 1 <= x < 3: print('Congratulations, you have money and a rad hobby')
else: print('You should really buy a plane')
